...
<head>
    ...
    <link rel="stylesheet" href="${path}/static/css/layuimini.css?v=2.0.4" media="all">
    <link rel="stylesheet" href="${path}/static/css/themes/default.css" media="all">
        ...
        <div class="layuimini-header-content">
            <a>
                <div class="layuimini-tool">
                    <i title="展开" class="fa fa-outdent" data-side-fold="1" id="i_shou"></i>
                </div>
            </a>
...
<script src="${path}/static/js/lay-config.js?v=2.0.0" charset="utf-8"></script>
<script>
    layui.use(['jquery', 'layer', 'miniAdmin', 'miniTongji'], function () {
        ...
        var options = {
            iniUrl: "${path}/static/api/init.json",    // 初始化接口
            clearUrl: "${path}/static/api/clear.json", // 缓存清理接口
