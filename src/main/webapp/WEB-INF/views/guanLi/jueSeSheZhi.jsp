    ...
    layui.use(['form', 'jquery', 'layer', 'tree','table'], function () {
        ...
        table.render({
            ...
            parseData: function (res) { //res 即为原始返回的数据
                ...
                {field: 'groupId', minWidth: 200, title: '角色ID',align: "center"},
                {field: 'groupName', minWidth: 200, title: '角色名',align: "center"},
                {field: 'groupDescript', minWidth: 120, title: '角色描述',align: "center"},
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            if (obj.event === 'add') {  // 监听添加操作
                ...
                layer.confirm('确定删除所选角色吗？', {offset: '100px', anim: 6, title: '提示'}, function (index) {
                    $.ajax({
                        type: 'POST',
                        url: '${path}/jueSeSheZhi/batchDelete.do',
