    ...
    layui.use(['form', 'jquery', 'layer', 'tree','table'], function () {
        ...
        table.render({
            ...
            parseData: function (res) { //res 即为原始返回的数据
                ...
                {field: 'userId', minWidth: 200, title: '用户ID',align: "center"},
                {field: 'username', minWidth: 200, title: '用户名',align: "center"},
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            if (obj.event === 'add') {  // 监听添加操作
                var index = layer.open({
                    ...
                    area: ['80%', '80%'],
                    offset: 't',
                    content: '${path}/to_yongHuSheZhi_add.do',
                    success: function () {
                        // layer.full(index);
                    }
                });
                ...
                $.each(data, function (i, d) {
                    itemNames[i] = d.username;
                });
                if(itemNames.length == 0){
                    layer.msg('请先选择至少一个！');
                    return false;
                }
                layer.confirm('确定删除所选用户吗？', {offset: '100px', anim: 6, title: '提示'}, function (index) {
                    $.ajax({
                        type: 'POST',
                        url: '${path}/yongHuSheZhi/batchDelete.do',
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                var index = layer.open({
                    ...
                    area: ['80%', '80%'],
                    offset: 't',
                    content: '${path}/to_yongHuSheZhi_edit.do',
                ...
                layer.confirm('确定删除此用户吗？', {offset: '100px', anim: 6, title: '提示'}, function (index) {
                    $.ajax({
                        type: 'POST',
                        url: '${path}/yongHuSheZhi/delete.do',
