...
<div class="layui-form layuimini-form" lay-filter="itemEditForm">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="groupId" lay-verify="required" lay-reqtext="角色名不可为空"  value=""
    ...
    <div class="layui-form layuimini-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="groupDescript"
                       value=""
                       class="layui-input">
            </div>
        </div>
        ...
        layui.use(['form'], function () {
            ...
            function form_data_show() {
                ...
                form.val("itemEditForm", {
                    ...
                    , "groupDescript": editData.groupDescript
                });
                return true;
            }
