...
<div class="layui-form layuimini-form" lay-filter="itemEditForm">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="userId" lay-verify="required" lay-reqtext="权限名不可为空"  value=""
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="username" lay-verify="required" lay-reqtext="用户名不可为空"  value=""
                   class="layui-input" >
        </div>
    </div>
    <div class="layui-form layuimini-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="password" lay-verify="required" lay-reqtext="密码不可为空" placeholder="请输入权限名"
